...
# import class Task dari file todoApp/models.py
from .models import Task
# import class TaskForm dari file todoApp/forms.py
from .forms import TaskForm


# Membuat View untuk halaman daftar tugas
...
def create_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            new_task.save()
            # mengeset pesan sukses dan redirect ke halaman daftar tugas
